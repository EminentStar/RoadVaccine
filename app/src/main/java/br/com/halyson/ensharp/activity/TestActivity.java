...
public class TestActivity extends Activity implements OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_maxdec = (TextView) findViewById(R.id.tv_maxdec);
        tv_maxdec.setTypeface(myTypeface);
    ...
    public void updateTv() {
        ...
        //tv_nowdec.setText(String.valueOf( currentDecibel));
        tv_maxdec.setText(String.format("최고 크기 : %.0f", maxDecibel));
