...
public class EnrollDataCaution implements Parcelable {
    ...
    public EnrollDataCaution()
    {
    }

    public EnrollDataCaution(String kind, String content, String time, String lat, String lon, String updown, String used_flag)
    {
        super();
        this.kind=kind;
    ...
    public EnrollDataCaution(Parcel in){
        readFromParcel(in);
    }
    ...
    public static final Creator CREATOR = new Creator() {
        ...
        @Override
        public EnrollDataCaution createFromParcel(Parcel in) {
            return new EnrollDataCaution(in);
        }

        @Override
        public EnrollDataCaution[] newArray(int size) {
            // TODO Auto-generated method stub
            return new EnrollDataCaution[size];
        }
    };
